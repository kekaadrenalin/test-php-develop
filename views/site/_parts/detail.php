...
<?php if (!empty($answer['taxOrgInfo'])) : foreach ($answer['taxOrgInfo'] as $taxOrgInfo) : ?>
    <hr>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php if (!empty($taxOrgInfo['taxPayerInfo'])) : foreach ($taxOrgInfo['taxPayerInfo'] as $taxPayerInfo) : ?>
                <hr>
                ...
                <?php if (!empty($taxPayerInfo['bccArrearsInfo'])) : ?>
                    <table class="table table-bordered table-hover">
                        <thead>
                        <tr>
                            <th>КБК</th>
                        ...
                        <tbody>
                        <?php foreach ($taxPayerInfo['bccArrearsInfo'] as $bccArrearsInfo) : ?>
                            <tr>
